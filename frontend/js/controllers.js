...
angular.module('phonecatControllers', ['templateservicemod', 'navigationservice', 'assignmenttemplate', 'ui.bootstrap', 'ui.select', 'ngAnimate', 'toastr', 'ngSanitize', 'angular-flexslider', 'ui.tinymce', 'imageupload', 'ngMap', 'toggle-switch', 'cfp.hotkeys', 'ui.sortable', 'infinite-scroll', 'dragularModule', 'cleave.js', 'monospaced.elastic'])
        ...
        NavigationService.getLoginEmployee($.jStorage.get("profile").email, function (data) {
            ...
            NavigationService.getDashboardCounts(formData, function (data) {
                ...
                _.each($scope.Arr, function (n) {
                    console.log(n);
                    $scope.Total = $scope.Total + n.count;
                });
                var totalObj = {
                    _id: "Total",
                    count: $scope.Total
    ...
    .controller('ModelViewCtrl', function ($scope, $window, hotkeys, TemplateService, NavigationService, $timeout, $state, $stateParams, toastr, $uibModal) {
        ...
        $scope.clearFilter = function () {
            // console.log("Sorting", $scope.filter.sorting);
            $scope.filter.from = "";
    ...
    .controller('InvoiceViewCtrl', function ($scope, $window, hotkeys, TemplateService, NavigationService, $timeout, $state, $stateParams, toastr, $uibModal) {
        ...
        ownerId = $scope.getLoginEmployee._id;
        $scope.ownersId = $scope.getLoginEmployee._id;
        $scope.confCancel = function (id) {
            console.log("In confInvoice", id);
    ...
    .controller('CreateAssignmentCtrl', function ($scope, $window, TemplateService, hotkeys, NavigationService, $filter, $timeout, $state, toastr, $stateParams, $uibModal) {
        ...
        $scope.submit = function (formData) {
            ...
            NavigationService.assignmentSave($scope.formData, function (data) {
                ...
                if (data.value === true) {
                    // $scope.assignmentMatchedData.matchedData = data.data.matchedData;
                    // console.log("matched data : ", $scope.assignmentMatchedData.matchedData);
    ...
    .controller('CreateInvoiceCtrl', function ($scope, $window, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr) {
        ...
        $scope.message.employee = $scope.getLoginEmployee._id;
        $scope.message.employeeData = $scope.getLoginEmployee;
        $scope.employee = [];
        $scope.getParentEmployee();
        ...
        $scope.saveDraft = function (data) {
            ...
            $scope.formData.approvalStatus = "Draft";
            $scope.formData.reqtimestamp = Date.now();
            $scope.formData.draftTimeStamp = Date.now();
                ...
                if (data.value === true) {
                    ...
                    NavigationService.modelSave("Assignment", $scope.assignment, function (data) {
                        if (data.value === true) {
                            ...
                            a.title = "Invoice Saved to Draft";
                            var success = [];
                            success[0] = "";
                            success[1] = "Invoice Saved to Draft Successfully";
                            $scope.updateTimelineChat(a, success);
                        } else {
                            toastr.clear();
                            toastr.error("Invoice Template creation failed.", "Invoice Template creation error");
                        }
                ...
                if (data.value === true) {
                    ...
                    NavigationService.modelSave("Assignment", $scope.assignment, function (data) {
                        if (data.value === true) {
                            ...
                            var success = ["", "Invoice Created Successfully"];
                            $scope.sendMessage(data.data.name, success);
                        } else {
                            toastr.clear();
                            toastr.error("Invoice Template creation failed.", "Invoice Template creation error");
                        }
    ...
    .controller('EditInvoiceCtrl', function ($scope, $window, $uibModal, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr) {
        ...
        NavigationService.getOneModel("Invoice", $stateParams.invoiceId, function (data) {
            ...
            $scope.abc = add1($scope.formData.assignment._id);
            NavigationService.getTimeline($scope.formData.assignment._id, function (data) {
                $scope.timeline = data.data;
            });
            NavigationService.getOneModel("Assignment", $scope.formData.assignment._id, function (data) {
                $scope.assignment = data.data;
                if ($scope.assignment.survey.length !== 0) {
                    $scope.surveyDate = moment(new Date($scope.assignment.survey[$scope.assignment.survey.length - 1].surveyDate)).add(5, "hours").add(30, "minutes").format("DD/MM/YYYY");
                }
                ...
                console.log("Assignment", $scope.assignment);
                if ($scope.assignment.customer) {
                    console.log("ABCDEF", $scope.billedTos);
                    $scope.billedTos.push($scope.assignment.customer);
                }
                if ($scope.assignment.insuredOffice) {
                    $scope.billedTos.push($scope.assignment.insuredOffice);
                ...
                console.log("$scope.billedTos", $scope.billedTos);
                $scope.oldbilledTos = _.cloneDeep($scope.billedTos);
            });
        ...
        $scope.saveModel = function (data) {
            ...
            if ($scope.approval) {
                ...
                if ($scope.formData.approvalTime === undefined) {
                    $scope.formData.approvalTime = Date.now();
                }
            } else {
                console.log("Approval Time", $scope.formData.approvalTime);
                $scope.formData.approvalStatus = "Pending";
                $scope.formData.reqtimestamp = Date.now();
            }
            NavigationService.modelSave("Invoice", $scope.formData, function (data) {
                    ...
                    if ($scope.approval) {
                        NavigationService.generateInvoicePdf($scope.formData, function (data) {
                            if (data.value === true) {
                                ...
                                NavigationService.modelSave("Invoice", $scope.formData, function (data) {});
                                $scope.assignment.getAllTaskStatus.invoice = "Done"; // FOr Global Inv Check
                                $scope.assignment.getAllTaskStatus.invoiceTime = Date.now();
                                NavigationService.modelSave("Assignment", $scope.assignment, function (data) {});
                                $window.history.back();
                                toastr.success("Invoice Authorised successfully.");
                            } else {
                                $scope.disableSave = false;
                                toastr.error("Invoice Authorisation  failed.");
                            }
                        });
                    } else {
                        $scope.sendMessage(data.data.name);
                        ...
                        NavigationService.modelSave("Assignment", $scope.assignment, function (data) {});
                        $window.history.back();
                        toastr.success("Invoice sent for Authorisation");
                        $scope.disableSave = false;
                    }
        ...
        $scope.saveRevise = function () {
            ...
            toastr.error("Please Wait for Response");
            NavigationService.modelSave("Invoice", $scope.formData, function (data) {
                console.log("New Invoice", data);
                if (data.value === true) {
                    NavigationService.generateInvoicePdf($scope.formData, function (data) {
                        if (data.value === true) {
                            console.log("Data of Pdf", data.data.name, $scope.formData.assignment, $scope.formData._id);
                            $scope.sendMessage(data.data.name);
                            $scope.formData.file = data.data.name;
                            NavigationService.modelSave("Invoice", $scope.formData, function (data) {});
                            NavigationService.modelSave("Assignment", $scope.assignment, function (data) {});
                            $window.history.back();
                            toastr.success("Invoice Template created successfully.", "Invoice Template Created");
                        } else {
                            $scope.saveForInvoiceList = true;
                            toastr.error("Invoice Failed While Saving Revised");
                        }
                    });
                } else {
                    $scope.saveForInvoiceList = true;
        ...
        $scope.comment = function (filterStatus) {
            console.log("Data In Filter", filterStatus);
            ...
            NavigationService.getOneModel("Assignment", $stateParams.assignmentId, function (data) {
                ...
                console.log("ABCDEF", $scope.assignmentData);
            });
        };
        $scope.submitReject = function (filter) {
            ...
            var a = {};
            a.title = "Invoice " + $scope.formData.invoiceNumber + " Rejected Please Create New  Invoice";
            ...
            NavigationService.saveChat($scope.timeline, function (data) {});
            $scope.formData.approvalStatus = "Rejected";
            NavigationService.modelSave("Invoice", $scope.formData, function (data) {});
            $scope.assignmentData.invoice.pop($scope.assignmentData.invoice.length - 1);
            NavigationService.modelSave("Assignment", $scope.assignmentData, function (data) {
                if (data.value === true) {
                    $window.history.back();
                    toastr.success("Invoice Rejected");
                } else {
                    toastr.error("Revise Failed");
                }
            });
        };
        $scope.submitRevise = function (filter) {
            var goto = "invoiceApproval-list";
            var a = {};
            a.title = "Invoice " + $scope.formData.invoiceNumber + " Regenerated";
            a.invoiceNumber = $scope.formData.invoiceNumber;
            a.type = "Normal",
                a.employee = $scope.message.employee,
                a.message = filter.comment;
            ...
            NavigationService.modelSave("Invoice", $scope.formData, function (data) {
                if (data.value === true) {
                    $window.history.back();
                    toastr.success("Invoice Regenerated");
                } else {
        ...
        $scope.saveDraft = function (data) {
            ...
            NavigationService.modelSave("Invoice", $scope.formData, function (data) {
                if (data.value === true) {
                    ...
                    toastr.error("There was an error while saving invoice as draft", "Failed Saving As Draft");
                }
            });
        };
    })
    ...
    .controller('TemplateViewCtrl', function ($scope, $uibModal, $window, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr, AssignmentTemplate) {
        ...
        $scope.checkconfirmNoDocsPending = function () {
            ...
            // _.each($scope.confirmDocsRecieved,function(n){
            //     if(n=="false"){
            //         $scope.confirmNoDocsPending = false;
            //     }
            // })      
        };
        $scope.getParentEmployee = function () {
        ...
        $scope.saveDraft = function (templateObj) {
            ...
            NavigationService.editAssignmentTemplate($scope.forms, function (data) {
                ...
                if (data.value) {
                    ...
                    var success = [];
                    success[0] = "";
                    success[1] = type + " Saved to Draft Successfully";
                    $scope.saveAssignment(obj, type, a, success);
                } else {
                    toastr.clear();
                    toastr.error("There was an error while saving " + type + " Template.", "Error " + type + " Template");
                    $window.history.back();
                    ...
                    if (templateObj.lorCount == "NA") {
                        NavigationService.editAssignmentTemplate($scope.forms, function (data) {
                            ...
                            if (data.value) {
                                ...
                                a.type = "Normal";
                                a.employee = $scope.message.employee;
                                a.title = "LOR " + templateObj.templateName + " Sent to Approval";
                                var obj = {
                                    assignId: $scope.assignment._id,
                                    _id: $scope.forms._id,
                                ...
                                var success = [];
                                success[0] = "Updated " + $stateParams.type + " for " + $scope.assignment.name;
                                success[1] = $stateParams.type;
                                $scope.saveAssignment(obj, "LOR", a, success);
                            } else {
        ...
        $scope.confirmAllDocs = function (templateObj) {
            ...
            // $scope.forms.assignment.timelineStatus = "Assessment Pending";
            $scope.forms.assignment.getAllTaskStatus.docs = "Done";
            $scope.forms.assignment.getAllTaskStatus.docsTime = Date.now();
            NavigationService.modelSave("Assignment", $scope.forms.assignment, function (data) {
                if (data.value) {
                    NavigationService.setGlobalAssignmentStatus($scope.forms.assignment, function (data) {});
                }
            });
        ...
        $scope.acceptModel = function (templateObj) {
            ...
            console.log("$scope.assignment", $scope.assignment);
            if (templateObj.type == "templateLor") {
                $scope.assignment.getAllTaskStatus.lor = "Done",
                    $scope.assignment.getAllTaskStatus.lorTime = Date.now();
            }
            if (templateObj.type == "templateIla") {
                $scope.assignment.getAllTaskStatus.ila = "Done",
                    $scope.assignment.getAllTaskStatus.ilaTime = Date.now();
            }
            NavigationService.modelSave("Assignment", $scope.assignment, function (data) {
                if (data.value) {
        ...
        $scope.submitRevise = function (filter) {
            ...
            var success = [];
            success[0] = "Revised " + $stateParams.type + " for " + $scope.assignment.name;
            success[1] = $stateParams.type;
            $scope.saveAssignment(obj, type, a, success);
            $timeout(function () {
                $state.go(goto, {});
    ...
    .controller('TimelineCtrl', function ($scope, $window, TemplateService, NavigationService, AssignmentTemplate, $timeout, $uibModal, $stateParams, toastr, $filter, $state) {
        ...
        $scope.assignmentRefresh = function () {
            NavigationService.getOneModel("Assignment", $stateParams.id, function (data) {
                $scope.assignment = data.data;
                if ($scope.assignment.getAllTaskStatus === undefined) {
                    $scope.assignment.getAllTaskStatus = {
                        ila: "Not Done",
                        lor: "Not Done",
                        survey: "Not Done",
                        consent: "Not Done",
                ...
                if ($scope.assignment.ilaAccess === undefined) {
                    $scope.assignment.ilaAccess = $scope.assignment.branch.ITAT;
                ...
                if ($scope.assignment.lorAccess === undefined) {
                    $scope.assignment.lorAccess = $scope.assignment.branch.LTAT;
                ...
                if ($scope.assignment.surveyAccess === undefined) {
                    $scope.assignment.surveyAccess = $scope.assignment.branch.STAT;
                ...
                if ($scope.assignment.consentAccess === undefined) {
                    $scope.assignment.consentAccess = $scope.assignment.branch.CTAT;
                ...
                if ($scope.assignment.assessmentAccess === undefined) {
                    $scope.assignment.assessmentAccess = $scope.assignment.branch.ATAT;
                ...
                if ($scope.assignment.fsrAccess === undefined) {
                    $scope.assignment.fsrAccess = $scope.assignment.branch.FSR;
        ...
        $scope.saveSurvey = function (assignment) {
            if (assignment.survey.length == 0) {
                if (assignment.surveyAccess) {
                    ...
                    $scope.message.title = "Survey Compulsory";
                } else {
                    assignment.getAllTaskStatus.survey = "Waived";
                    assignment.getAllTaskStatus.surveyAssigned = "Waived";
                    $scope.message.title = "Survey Waived";
                }
                $scope.sendMessage("Normal");
                NavigationService.setGlobalAssignmentStatus(assignment, function (data) {
                    $state.reload();
                });
            } else {
                toastr.error("Process Already Started");
        ...
        $scope.saveILA = function (assignment) {
            if (assignment.templateIla.length == 0) {
                if (assignment.ilaAccess) {
                    ...
                    $scope.message.title = "ILA Compulsory";
                } else {
                    assignment.getAllTaskStatus.ila = "Waived";
                    $scope.message.title = "ILA Waived";
                }
                $scope.sendMessage("Normal");
                NavigationService.setGlobalAssignmentStatus(assignment, function (data) {
                    $state.reload();
                ...
                toastr.error("ILA Exists Cannot Waive");
                $state.reload();
            }
        }
        $scope.saveLOR = function (assignment) {
        ...
        $scope.saveSurveyDate = function (date) {
            ...
            var formdata = {};
            // console.log('$scope.surveyClass ',$scope.surveys.surveyClass );
        ...
        $scope.getAssignmentData = function (type) {
            ...
            NavigationService.getOneModel("Assignment", $stateParams.id, function (data) {
                $scope.assignment = data.data;
                // console.log("$scope.assignment", $scope.assignment);
                // console.log("$scope.search.keyword", $scope.search.keyword);
                if (type === true) {
                    data.data.keyword = $scope.search.keyword;
                }
                console.log('data.data.keyord', data.data.keyword);
        ...
        $scope.getSurveyors = function (date) {
            $scope.surveys.surveyClass = 'survey-assigned';
            var formdata = {};
            $scope.surveyDate = date;
            formdata.surveyDate = date;
        ...
        $scope.updateAssignmentEmployee = function (empId) {
            ...
            NavigationService.updateSurveyor(assignment, function (data) {
                if (data.value) {
                    ...
                    $scope.afterSurveyAssign(empId);
                } else {
                    toastr.error("There was an error while Surveyor sending approval", "Error Surveyor Sending for Approval");
                }
        ...
        $scope.afterSurveyAssign = function (employee) {
            ...
            $timeout(function () {
                $scope.sendMessage("Normal");
                toastr.success("", "Surveyor Sending for Approval Successfully");
                $state.reload();
            }, 1000);
        };
        ...
        $scope.deleteTemplate = function (type, index, name) {
            console.log("Raj2 ", index, type, $scope.assignment[type][index].approvalStatus);
        ...
        $scope.ilaCreateCheck = function () {
            // ng-if="((assignment.templateIla.length==0 && assignment.dateOfLoss && assignment.branch.ITAT && assignment.typeOfClaim && assignment.isInsured && assignment.timelineStatus !== 'Force Closed')||(assignment.templateIla.length==0 && assignment.dateOfLoss && assignment.branch.ITAT && assignment.typeOfClaim && assignment.isInsured && ilaAccess && assignment.ilaAccess && assignment.timelineStatus !== 'Force Closed'))"
        ...
        $scope.onJirUploadCallback = function (data, length) {
            ...
            if ($scope.checker === length) {
                ...
                var newArray = _.each($scope.arr, function (n) {
                    ...
                    a.fileName = Date.now();
                    a.type = "Normal";
                    a.title = "Jir Uploaded";
                    a.attachment = n;
                    $scope.assignment.jir.push(_.cloneDeep(a));
                    $scope.sendMessageFromPhoto(_.cloneDeep(a));
                    console.log("Array to be Passed", a);
                });
                $scope.arr = [];
                $scope.saveAssignment("Jir");
            } else {
                $scope.arr.push(data);
                $scope.checker++;
            }
            ...
            if ($scope.checker === length) {
                ...
                var newArray = _.each($scope.arr, function (n) {
                    a.employee = $scope.message.employee,
                        ...
                        a.fileName = Date.now();
                    a.type = "Normal",
                        a.title = "Consent Uploaded",
                        a.attachment = n;
                    $scope.assignment.consent.push(_.cloneDeep(a));
                    $scope.sendMessageFromPhoto(_.cloneDeep(a));
                });
                $scope.arr = [];
                $scope.saveAssignment("Consent");
                console.log("After Save", $scope.arr);
    ...
    .controller('SbcApprovalsCtrl', function ($scope, $window, TemplateService, NavigationService, $timeout, base64, $stateParams, $state, toastr, $uibModal) {
                ...
                if (data.value) {
                    NavigationService.getOneModel("Timeline", $scope.assignment.timeline[0], function (data) {
                        ...
                        NavigationService.getOneModel("Assignment", $scope.assignment._id, function (data) {
                            $scope.newAssignment = data.data;
                            $scope.newAssignment.getAllTaskStatus.surveyAssigned = "Done",
                                $scope.newAssignment.getAllTaskStatus.surveyAssignedTime = Date.now();
                            NavigationService.modelSave("Assignment", $scope.newAssignment, function (data) {
                                if (data.value) {
                                    NavigationService.setGlobalAssignmentStatus($scope.newAssignment, function (data) {});
                                }
                            });
                        });
                        toastr.success("Surveyor " + $scope.assignment.survey.employee.name + " Approved Successfully");
                    });
                } else {
                    toastr.error("There was an error while surveyor approving", "Error Surveyor Approving");
                }
        ...
        $scope.close = function (data) {
            ...
            if (data == true) {
                NavigationService.removeSurveyor(formData, function (data) {
                    if (data.value) {
                        NavigationService.getOneModel("Timeline", $scope.surveyor.timeline[0], function (data) {
                            $scope.timeline = data.data;
                            var a = {};
                            a.title = "Surveyor " + surveyorName + " Rejected for Survey";
                            a.type = "Normal";
                            a.surveyor = formData.surveyId;
                            a.employee = $scope.employee;
                            $scope.timeline.chat.push(a);
                            $scope.saveOnTimeline();
                            toastr.success("Surveyor " + surveyorName + " Rejected Successfully");
                        });
                    } else {
                        toastr.error("There was an error occured while rejecting surveyor " + surveyorName);
                    }
                    $scope.showAll();
                });
            } else {
    ...
    .controller('AssignmentApprovalsCtrl', function ($scope, $window, TemplateService, NavigationService, $timeout, base64, $stateParams, $state, toastr, $uibModal) {
        ...
        $scope.acceptForceClosed = function (assignment) {
            ...
            NavigationService.getOneModel("Timeline", $scope.assignment.timeline[0], function (data) {
                ...
                $scope.saveOnTimeline();
                formData = {};
                formData.getAllTaskStatus = $scope.assignment.getAllTaskStatus;
                if ($scope.assignment.assignmentapprovalStatus == "Pending ForceClosed") {
                ...
                NavigationService.modelSave("Assignment", formData, function (data) {
                    if (data.value == true) {
                        ...
                        timeline.chat = {};
                        if ($scope.assignment.assignmentapprovalStatus == "Pending ForceClosed") {
                            timeline.chat.title = "Assignment " + $scope.assignment.name + " ForceClosed";
                        } else if ($scope.assignment.assignmentapprovalStatus == "Pending ReOpened") {
                            timeline.chat.title = "Assignment " + $scope.assignment.name + " ReOpened";
                        } else if ($scope.assignment.assignmentapprovalStatus == "Pending OnHold") {
                            timeline.chat.title = "Assignment " + $scope.assignment.name + " OnHold";
                        }
                        timeline.chat.type = "Normal";
                        timeline.chat.employee = $scope.employee._id;
                        timeline.assignment = assignment._id;
                        var success = {};
                        success[0] = "";
                        success[1] = "Assignment " + $scope.assignment.name + " ForceClosed Successfully";
                        $scope.updateTimelineChat(timeline, success);
                    }
                });
            });
